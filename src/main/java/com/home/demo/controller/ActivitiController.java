...
import com.home.demo.bean.TaskRepresentation;
...
public class ActivitiController {
    ...
    public String startProcess() {
        ...
        return "Process started. Number of currently running process instances = " 
	        	    ...
	        	    + " and my-process's  processInstanceId = "
	        		+ taskService.createTaskQuery().processDefinitionKeyLikeIgnoreCase("my-process")
